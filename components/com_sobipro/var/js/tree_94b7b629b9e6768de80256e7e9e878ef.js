 ...
 */
 // Created at Tue Nov 19 8:59:50 IST 2013 by Sobi Pro Component
...
var menuTree_stmWait = 'http://egged4u.co.il/media/sobipro/styles/spinner.gif';

menuTree_stmImgs[ 'root' ] = 'http://egged4u.co.il/media/sobipro/tree/base.gif';
menuTree_stmImgs[ 'join' ] = 'http://egged4u.co.il/media/sobipro/tree/join.gif';
menuTree_stmImgs[ 'joinBottom' ] = 'http://egged4u.co.il/media/sobipro/tree/joinbottom.gif';
menuTree_stmImgs[ 'plus' ] = 'http://egged4u.co.il/media/sobipro/tree/plus.gif';
menuTree_stmImgs[ 'plusBottom' ] = 'http://egged4u.co.il/media/sobipro/tree/plusbottom.gif';
menuTree_stmImgs[ 'minus' ] = 'http://egged4u.co.il/media/sobipro/tree/minus.gif';
menuTree_stmImgs[ 'minusBottom' ] = 'http://egged4u.co.il/media/sobipro/tree/minusbottom.gif';
menuTree_stmImgs[ 'folder' ] = 'http://egged4u.co.il/media/sobipro/tree/folder.gif';
menuTree_stmImgs[ 'disabled' ] = 'http://egged4u.co.il/media/sobipro/tree/disabled.gif';
menuTree_stmImgs[ 'folderOpen' ] = 'http://egged4u.co.il/media/sobipro/tree/folderopen.gif';
menuTree_stmImgs[ 'line' ] = 'http://egged4u.co.il/media/sobipro/tree/line.gif';
menuTree_stmImgs[ 'empty' ] = 'http://egged4u.co.il/media/sobipro/tree/empty.gif';;

menuTree_stmImgMatrix[ 131 ] = new Array( 'plusBottom' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=115&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
