 ...
 */
 // Created at Tue Nov 19 9:05:53 IST 2013 by Sobi Pro Component

var sobiCats_stmcid = 0;
var sobiCats_stmLastNode = 131;
...
var sobiCats_stmWait = 'http://egged4u.co.il/media/sobipro/styles/spinner.gif';

sobiCats_stmImgs[ 'root' ] = 'http://egged4u.co.il/media/sobipro/tree/base.gif';
sobiCats_stmImgs[ 'join' ] = 'http://egged4u.co.il/media/sobipro/tree/join.gif';
sobiCats_stmImgs[ 'joinBottom' ] = 'http://egged4u.co.il/media/sobipro/tree/joinbottom.gif';
sobiCats_stmImgs[ 'plus' ] = 'http://egged4u.co.il/media/sobipro/tree/plus.gif';
sobiCats_stmImgs[ 'plusBottom' ] = 'http://egged4u.co.il/media/sobipro/tree/plusbottom.gif';
sobiCats_stmImgs[ 'minus' ] = 'http://egged4u.co.il/media/sobipro/tree/minus.gif';
sobiCats_stmImgs[ 'minusBottom' ] = 'http://egged4u.co.il/media/sobipro/tree/minusbottom.gif';
sobiCats_stmImgs[ 'folder' ] = 'http://egged4u.co.il/media/sobipro/tree/folder.gif';
sobiCats_stmImgs[ 'disabled' ] = 'http://egged4u.co.il/media/sobipro/tree/disabled.gif';
sobiCats_stmImgs[ 'folderOpen' ] = 'http://egged4u.co.il/media/sobipro/tree/folderopen.gif';
sobiCats_stmImgs[ 'line' ] = 'http://egged4u.co.il/media/sobipro/tree/line.gif';
sobiCats_stmImgs[ 'empty' ] = 'http://egged4u.co.il/media/sobipro/tree/empty.gif';;

sobiCats_stmImgMatrix[ 131 ] = new Array( 'plusBottom' );;
//__PARENT_ARR__
...
function sobiCats_stmExpand( catid, deep, pid ) 
{
	...
	sobiCats_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.chooser&sid=115&out=xml&expand=" + sobiCats_stmcid + "&pid=" + sobiCats_stmPid + "&tmpl=component&format=raw";
