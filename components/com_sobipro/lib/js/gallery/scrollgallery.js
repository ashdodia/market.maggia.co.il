...
(function($){
    ...
    JfScrollGallery = new Class({
        ...
        initialize: function(options){
            ...
            this.resizeimageareaFx = new Fx.Morph(this.options.imagearea);
            //AutoScroll
            //init Thumb-Images
            if($(this.options.thumbarea)){
                ...
                Array.each(this.tumbObjs, function(imgObjekt, index){
                    imgObjekt.addEvent('click', function(index){
                        ...
                        this.resizeimageareaFx.start({
                            width: this.imgObjs[index].width,
                            height: this.imgObjs[index].height
                        });
                ...
                if(this.options.autoScroll==false){
                    this.scrollthumbareaFx = new Scroller($(this.options.thumbarea), {
