...
?>
		...
		<div class="componentheading" id="ijadagencytransition">
			<h1><?php echo JText::_('AD_TRANSITION');  ?></h1>
		...
		?>
 	<form action="<?php echo JRoute::_('index.php?option=com_adagency&controller=adagencyTransition&task=edit&cid='.$_row->id);?>" method="post" name="adminForm" id="adminForm">
<table border="0" width="100%" class="adminform">
		...
		<tr>
			...
			<td width="75%">
				<input class="formField agency_textbox" type="text" name="title" id="transition_title" style="width: 99%;" value="<?php if ($_row->title!="") {echo $_row->title;} else {echo "";} ?>">
			</td>
		</tr>

		<tr>
			<td width="25%">
				<span class="agency_label"><?php echo JText::_('NEWADDESCTIPTION');?></label>
			</td>
			<td width="75%">
				<input class="formField agency_textbox" type="text" name="description" id="transition_description" style="width: 99%;" value="<?php if ($_row->description!="") {echo $_row->description;} else {echo "";} ?>" />
			</td>
		</tr>
